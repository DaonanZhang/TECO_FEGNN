...
def main(hold_out, seed):
    ...
    for mask_distance in [10]:
        ...
        dataloader_ev = torch.utils.data.DataLoader(dataset_eval, batch_size=settings['batch'], shuffle=False, collate_fn=dl.collate_fn, num_workers=2, prefetch_factor=8, drop_last=True)
        ...
        for x_b, c_b, y_b, input_lengths in dataloader_ev:
            ...
            outputs_b = x_b[0,0,0].unsqueeze(0)
            targets_b = y_b[0,0]
...
if __name__ == "__main__":
    ...
    for hold_out_i in hold_out_list:
        for seed_i in seed_list:
            ...
            print(f'solving holdout {hold_out_i} and seed {seed_i}')
