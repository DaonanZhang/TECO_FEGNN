...
import Dataloader_reg4_pe_only as dl
from model_pe_only import *
import torch.optim as optim
from torch.nn import functional as F
from scipy import stats
from sklearn.metrics import mean_absolute_error, mean_squared_error, mean_absolute_percentage_error
from matplotlib.lines import Line2D
import myconfig_pe_only as myconfig
    ...
    while True:
        try:
            ...
            for dataloader_ex in test_dataloaders:
                ...
                for x_b, c_b, y_b, input_lengths in dataloader_ex:

                    x_b, c_b, y_b, input_lengths = x_b.to(device), c_b.to(device), y_b.to(
                        device), input_lengths.to(device)
                    outputs_b, targets_b = model(x_b, y_b, c_b, input_lengths, True)
            ...
            x_b, c_b, y_b, input_lengths = batch
